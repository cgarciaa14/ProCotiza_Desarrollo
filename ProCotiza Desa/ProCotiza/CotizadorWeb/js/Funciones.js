...
//BBV-P-412: RQ LOGIN gvargas: 03/01/2017 Se agrego opcion 20 a ValCarac para las tasas iva letras,numeros y Dot
//BUG-PC-34 MAUT 16/01/2017 Se agrega el backspace para que lo reconozca Firefox
//BUG-PC-42 JRHM 30/01/17 Se agrego metodo new check decimals
//BUG-PC-46 JRHM 13/02/17 SE AGREGA OPCION 21 PARA VALCARAC PARA VALIDAR CARACTERES EN NOMBRES DE AGENCIAS (PERMITIRA NUMEROS, LETRAS Y SIMBOLOS ESPACIALES)
//BUG-PC-41:PVARGAS:27/01/2017:SE AGREGA EL BACKSPACE PARA QUE PERMITA BORRAR.
//BUG-PC-119: RIGLESIAS:03/11/2017:ELIMINAR RESTRICCIÓN DE COPIAR Y PEGAR EN PAQUETES FINACIEROS, USUARIOS Y AGENCIAS 
...
function ValidaFecha(e)
    ...
    function ValCarac(evt, opc) {
        ...
        //opc=20 --> Letras Mayúsculas, Minúsculas y punto
	    switch (opc) {
