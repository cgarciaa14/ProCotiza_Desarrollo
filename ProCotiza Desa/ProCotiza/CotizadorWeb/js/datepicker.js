...
Calendar.prototype.show = function() {
	...
	this.wwrite("<A HREF=\"" +
		...
		");" +
		"\"><img src='../img/go_back2.gif' border=0><\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + prevMM + "', '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><img src='../img/go_back.gif' border=0><\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"javascript:window.print();\"><img src='../img/Print.gif' border=0></A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + nextMM + "', '" + nextYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><img src='../img/go_next.gif' border=0><\/A></TD><TD ALIGN=center>");
	this.wwrite("<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><img src='../img/go_next2.gif' border=0><\/A></TD></TR></TABLE><BR>");
...
Calendar.prototype.showY = function() {
	...
	this.wwrite("<link rel='stylesheet' href='Style.css'>")
...
function AbreDivCal(txt){
    if(self.gfPop){
        gfPop.fPopCalendar(document.getElementById(txt));
    }    
    return false;
}