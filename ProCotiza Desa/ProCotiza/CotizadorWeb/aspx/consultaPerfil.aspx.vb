'BBV-P-412:AVH:14/07/2016 RQB: SE CREA CATALOGO PERFILES
'BBV-P-412:BUG-PC-35 18/01/2017 JRHM Se agrega objeto para solucion de fallas
Imports System.Data
Partial Class aspx_consultaPerfil
    ...
    Protected Sub btnAgregar_Click(sender As Object, e As System.EventArgs) Handles btnAgregar.Click
        Response.Redirect("./manejaPerfil.aspx?idPerfil=-1")
    End Sub
    ...
    Protected Sub grvConsulta_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles grvConsulta.RowCommand
        If e.CommandName = "perfilId" Then
            If e.CommandArgument <> 71 Then
            Response.Redirect("./manejaPerfil.aspx?idPerfil=" & e.CommandArgument)
            Else
                MensajeError("No puede modificar el perfil seleccionado.")
            End If
        End If
    End Sub
End Class
