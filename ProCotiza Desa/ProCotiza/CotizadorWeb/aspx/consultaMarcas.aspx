<%@ Page Title="" Language="VB" MasterPageFile="~/aspx/Principal.master" AutoEventWireup="false" CodeFile="consultaMarcas.aspx.vb" Inherits="aspx_consultaMarcas" %>
...
<%--BUG-PC-43 01/02/17 JRHM Se agrego clase wrap a tabla para casos donde nombre de marca sea demasiado grande para tabla--%>
        ...
        <fieldset style=" width:96.5%; padding-top:15px; border: .5px solid #D8D8D8;">
            ...
            <table class="resulbbva" style="width:90%;">
		        <tr>
                    ...
                    <td style="width:1%; text-align:right;">Marca:</td> <%--BUG-PC-09--%>
                    <td style="width:27%;"><asp:TextBox ID="txtNom" runat="server" CssClass="txt3BBVA" MaxLength="90"  Onkeypress="return ValCarac(event, 6);"></asp:TextBox></td> <%--BUG-PC-09--%>
            	</tr>
	    </table>
        </center>
        <center>
                            ...
                            <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="false" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Id" ItemStyle-Width="7%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="resul" CommandName="marcaId" CommandArgument='<%# Eval("id_marca") %>'><%#Eval("id_marca")%></asp:LinkButton>
                                        </ItemTemplate>                                            
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="nombre" HeaderText="Marca" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="resul2wrap"/> <%--BUG-PC-09--%>
                                ...
                                <asp:TemplateField HeaderText="Opciones" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px">
                                    <ItemTemplate>
                                        <div class="tooltip">
                                            <asp:ImageButton ID="ImageButton1" runat="server" Width="16" Height="16" CommandName="MarAge" CommandArgument='<%# Eval("id_marca") %>' ImageUrl="../img/house_go.png" AlternateText="Relaciona Agencias" />
