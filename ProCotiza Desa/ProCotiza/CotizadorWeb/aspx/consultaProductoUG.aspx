<%@ Page Title="" Language="VB" MasterPageFile="~/aspx/Principal.master" AutoEventWireup="false" CodeFile="consultaProductoUG.aspx.vb" Inherits="aspx_consultaProducto" %>
        ...
        <fieldset style=" width:96.5%; padding-top:15px; border: .5px solid #D8D8D8;">
            ...
            <table class="resulbbva" style="width:90%;">
		        <tr>
                    ...
                    <td style="width:27%;"><asp:TextBox ID="txtProducto" runat="server" CssClass="txt3BBVA" Width="190px" MaxLength="50"  Onkeypress="return ValCarac(event,14);" onkeyup="ReemplazaAcentos(event, this.id, this.value);"></asp:TextBox></td> <%-- JRHM 14/11/16 SE CAMBIO EL EVENTO KEYPRESS PARA QUE ESTE CAMPO SOLO PERMITA ALFANUMERICOS --%>
            	</tr>
	    </table>
        </center>
        <center>
                            ...
                            <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="false" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Id" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="resul" CommandName="ID_PRODUCTO_UG" CommandArgument='<%# Eval("ID_PRODUCTO_UG") %>'><%#Eval("ID_PRODUCTO_UG")%></asp:LinkButton>
                                        </ItemTemplate>                                            
                                    </asp:TemplateField>
