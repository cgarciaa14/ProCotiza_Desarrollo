'BUG-PC-133 GVARGAS 07/12/2017 Cambio Responsivo
'BUG-PC-138 GVARGAS 18/12/2017 Responsive Message Alert
...
Partial Class Pages_Cotizador
    ...
    Dim MuestraDeducible As Integer = 0
        ...
        If Not IsPostBack Then
            ...
            If CargaCombos() Then
                If CargaCombos2() Then
                    ...
                    ''BUG-PC-30
                    If (ddlalianza.SelectedValue = 2224 Or ddlalianza.SelectedValue = 2232) Or (idbroker = 5 Or idbroker = 9) Then
    ...
    Private Sub MensajeError(ByVal strMsj As String)
        ...
        lblMensaje.Text = "<script>MessageError('" + strMsj + "')</script>"
    End Sub
            ...
            If objPaq.ErrorPaquete = "" Then
                If dtsRes.Tables(0).Rows.Count > 0 Then
                    ...
                    Else
                        ...
                        End If
                        'MAPH 17/03/17 BUG-PC-49 Visibilidad y deshabilitacion de cajas de texto de subsidio --3
    ...
    Private Function CargaCombos2() As Boolean
        ...
        If (ddlalianza.SelectedValue = 2224 Or ddlalianza.SelectedValue = 2232) Or (brokerid = 5 Or brokerid = 9) Then
            dvrecurrecte.Visible = True
        Else
            dvrecurrecte.Visible = False
        End If
        ...
        Try
            ...
            If objPaq.ErrorPaquete = "" Then
                If dts.Tables(0).Rows.Count > 0 Then
                    ...
                    Dim _PtjSubsidio As String = CDbl(IIf(txtporsub.Text.Trim = "", 0, txtporsub.Text.Trim)) 'BUSCAR AQUI
            ...
            'If (rbtMonto.Checked = True) Then
            'objCot._intTipoDeducible = 3
            'ElseIf (rbtPorcentaje.Checked = True) Then
            'objCot._intTipoDeducible = 1
            'Else
            'objCot._intTipoDeducible = 3
            'End If
            ''objCot._DecDeducible = 0 'txtDeducible.Text
            'If (cmbDedusibleDaños.SelectedValue = -1) Then
            '    Exit Function
            'Else
            objCot._DecDeducible = cmbDedusibleDaños.SelectedValue
            objCot._Indemnizacion = cmbIndemnizacion.SelectedValue
            'End If
            'If (cmbDeducibleRoboTotal.SelectedValue = -1) Then
            '    Exit Function
            'Else
    ...
    Public Function ValidaDeducible() As Boolean
        ...
        If MuestraDeducible = 0 Then
            Return False
        Else
            If cmbDedusibleDaños.SelectedValue = -1 OrElse cmbDeducibleRoboTotal.SelectedValue = -1 Then
                Return True
            Else
                Return False
            End If
    ...
    Protected Sub btncotizaseg_Click(sender As Object, e As System.EventArgs) Handles btncotizaseg.Click
        ...
        Else
            'BUG-PC-128: CGARCIA: 23/11/2017: SE PONE BANDERA PARA APARESER O NO AL DEDUCIBLE
            If ddltipounidad.SelectedValue = 0 OrElse ddluso.SelectedValue = 0 OrElse ddlcobertura.SelectedValue = 0 OrElse ddlaseguradora.SelectedValue = 0 OrElse ValidaDeducible() = True Then
                ...
                End If
                'BUG-PC-128: CGARCIA: 23/11/2017: SE PONE BANDERA PARA APARESER O NO AL DEDUCIBLE
                If divDeducible.Visible = True Then
                    If cmbDedusibleDaños.SelectedValue = -1 Then
                ...
                End If
                    ...
                    'If cmbIndemnizacion.SelectedValue = -1 Then
                    '    MensajeError("Debe sleccionar una Indemnización ")
                    '    Exit Sub
                    'End If
                End If
    ...
    Protected Sub ddlmodelo_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlmodelo.SelectedIndexChanged
        ...
        'MAPH 17/03/17 BUG-PC-49 Visibilidad y deshabilitacion de cajas de texto de subsidio  --4
        VerificaSubsidio(objPaq)
    ...
    Protected Sub ddlplan_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlplan.SelectedIndexChanged
        ...
        'MAPH 17/03/17 BUG-PC-49 Visibilidad y deshabilitacion de cajas de texto de subsidio  --5
        VerificaSubsidio(objPaq)
    ...
    Protected Sub ddledo_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddledo.SelectedIndexChanged
        ...
        'MAPH 17/03/17 BUG-PC-49 Visibilidad y deshabilitacion de cajas de texto de subsidio --6
        VerificaSubsidio(objPaq)
    ...
    Protected Sub ddlagencia_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlagencia.SelectedIndexChanged
        ...
        'MAPH 17/03/17 BUG-PC-49 Visibilidad y deshabilitacion de cajas de texto de subsidio --7
        VerificaSubsidio(objPaq)
    ...
    Private Function CotizaSeg() As Boolean
        ...
        Dim intbroker As Integer = obten_broker()
        'If intbroker = 5 Or intbroker = 9 Then
    ...
    Protected Sub ddlversion_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlversion.SelectedIndexChanged
        ...
        'MAPH 17/03/17 BUG-PC-49 Visibilidad y deshabilitacion de cajas de texto de subsidio --8
        VerificaSubsidio(objPaq)
    ...
    Protected Sub ddlanio_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlanio.SelectedIndexChanged
        ...
        'MAPH 17/03/17 BUG-PC-49 Visibilidad y deshabilitacion de cajas de texto de subsidio --1
        VerificaSubsidio(objPaq)
    ...
    Protected Sub ddlmarca_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlmarca.SelectedIndexChanged
        ...
        'MAPH 17/03/17 BUG-PC-49 Visibilidad y deshabilitacion de cajas de texto de subsidio --2
        VerificaSubsidio(objPaq)
    ...
    Protected Sub ddlclasif_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlclasif.SelectedIndexChanged
        ...
        VerificaSubsidio(objPaq) 'Cambio urgente
    End Sub
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        ...
        End Try
        'Try
        '    If (CInt(ViewState("vwsTipoCalculo")) = 167) Then
        '        If (CInt(ViewState("vwsBrokerID")) = 5 Or CInt(ViewState("vwsBrokerID")) = 9) Then
        '            divDeducible.Visible = True
        '        Else
        '            divDeducible.Visible = False
        '        End If
        ...
        'End Try
    End Sub
    'Protected Sub rbtMonto_CheckedChanged(sender As Object, e As EventArgs)
    '    IIf(rbtMonto.Checked = False, lblPesos.Visible = True, lblPesos.Visible = False)
    'End Sub
    'Protected Sub rbtPorcentaje_CheckedChanged(sender As Object, e As EventArgs)
    '    IIf(rbtPorcentaje.Checked = False, lblPorcentaje.Visible = True, lblPorcentaje.Visible = False)
    'End Sub
End Class
